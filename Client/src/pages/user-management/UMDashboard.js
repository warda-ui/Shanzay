  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Box className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
        <Typography variant="h6" color="primary" className="sidebar-header">
          Admin Dashboard
        </Typography>
        <Button startIcon={<PersonAddIcon />} fullWidth className="sidebar-link">
          Add User
        </Button>
        <Button
...
>
  Pending Users
        ...
        <Button startIcon={<AdminPanelSettingsIcon />} fullWidth className="sidebar-link">
          Admin Dashboard
        </Button>
      </Box>
